...
def main() -> None:
    ...
    log0("condition_id:2026-04-29_mikey_III_8k_Loop_2x")
    ...
    log0("changed_fields:vocab 4096->8192, tokenizer/data sp4096->sp8192, add PR1493 depth recurrence, qk_gain env override if set, coprime_shards_per_batch 1->80, gpus 8->2 mechanics_proxy")
    log0("expected_metric:final_sliding_window_exact comparator:mikey_1p1_clean_and_PR1493_loop_signal_only")
