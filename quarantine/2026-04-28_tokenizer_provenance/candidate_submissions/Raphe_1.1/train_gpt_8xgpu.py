...
os.environ.setdefault("RUN_ID", "raphe_1p1_8x_seed444_" + time.strftime("%Y%m%d_%H%M%S"))
...
def main() -> None:
    ...
    if world_size != 8:
        raise ValueError(
            f"Raphe 1.1 8x requires WORLD_SIZE=8, got {world_size}. "
            "Launch with: torchrun --standalone --nproc_per_node=8 Raphe_1.1/train_gpt_8xgpu.py"
        )
    ...
    log0("condition_id:raphe_1p1_8x_seed444")
