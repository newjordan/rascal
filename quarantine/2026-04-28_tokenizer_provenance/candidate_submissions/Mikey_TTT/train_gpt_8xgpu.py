...
os.environ.setdefault("RUN_ID", "mikey_ttt_8x_seed444_" + time.strftime("%Y%m%d_%H%M%S"))
...
def main() -> None:
    ...
    if world_size != 8:
        raise ValueError(
            f"Mikey_TTT 8x requires WORLD_SIZE=8, got {world_size}. "
            "Launch with: torchrun --standalone --nproc_per_node=8 Mikey_TTT/train_gpt_8xgpu.py"
        )
    ...
    log0("condition_id:mikey_ttt_8x_seed444")
