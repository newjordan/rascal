...
def main() -> None:
    ...
    if world_size != 4:
        raise ValueError(
            f"Midnight 4k 4x requires WORLD_SIZE=4, got {world_size}. "
            "Launch with: torchrun --standalone --nproc_per_node=4 4k_vocab_midnight/train_gpt_4K_4xgpu.py"
        )
    if 8 % world_size != 0:
    ...
    log0("runner:midnight_iii_4xgpu_4k source:4k_vocab_midnight/train_gpt_4K_4xgpu.py")
