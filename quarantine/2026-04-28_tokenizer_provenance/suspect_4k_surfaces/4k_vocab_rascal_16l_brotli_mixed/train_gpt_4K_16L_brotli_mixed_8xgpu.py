...
os.environ.setdefault("RUN_ID", "rascal_4k_16L_brotli_mixed_8x_seed444_" + time.strftime("%Y%m%d_%H%M%S"))
...
def main() -> None:
    ...
    if world_size != 8:
        raise ValueError(
            f"Rascal 4k 16L brotli+mixed 8x requires WORLD_SIZE=8, got {world_size}. "
            "Launch with: torchrun --standalone --nproc_per_node=8 4k_vocab_rascal_16l_brotli_mixed/train_gpt_4K_16L_brotli_mixed_8xgpu.py"
        )
    ...
    log0("condition_id:rascal_4k_16L_brotli_mixed_8x_seed444")
    log0("run_label:salvage_v2 source_record:rascal_4k_8x_seed444_run20260427 axis:depth_16L_capacity_ceiling+brotli+mixed_int")
    log0("changed_fields:num_layers (11->16), compression (zstd->brotli+bshf), quant_policy (uniform_int6->mixed_int5_int6_int8)")
