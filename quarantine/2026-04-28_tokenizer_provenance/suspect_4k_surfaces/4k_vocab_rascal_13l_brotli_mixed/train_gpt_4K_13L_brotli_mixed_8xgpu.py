...
os.environ.setdefault("RUN_ID", "rascal_4k_13L_brotli_mixed_8x_seed444_" + time.strftime("%Y%m%d_%H%M%S"))
...
def main() -> None:
    ...
    if world_size != 8:
        raise ValueError(
            f"Rascal 4k 13L brotli+mixed 8x requires WORLD_SIZE=8, got {world_size}. "
            "Launch with: torchrun --standalone --nproc_per_node=8 4k_vocab_rascal_13l_brotli_mixed/train_gpt_4K_13L_brotli_mixed_8xgpu.py"
        )
    ...
    log0("condition_id:rascal_4k_13L_brotli_mixed_8x_seed444")
    log0("run_label:capacity_ceiling source_record:rascal_4k_10L_brotli_mixed_8x_seed444_pr1120beater axis:depth_13L_capacity_ceiling+brotli+mixed_int")
    log0("changed_fields:num_layers (11->13), compression (zstd->brotli+bshf), quant_policy (uniform_int6->mixed_int5_int6_int8)")
    log0("expected_metric:post_quant_val_bpb comparator:1.10986874_pr1120_record note:quality_ceiling_test_will_likely_exceed_16MB_cap")
