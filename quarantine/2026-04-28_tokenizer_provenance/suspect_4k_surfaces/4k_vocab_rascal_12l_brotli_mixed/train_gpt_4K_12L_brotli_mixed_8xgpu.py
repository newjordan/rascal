...
os.environ.setdefault("RUN_ID", "rascal_4k_12L_brotli_mixed_8x_seed444_" + time.strftime("%Y%m%d_%H%M%S"))
...
def main() -> None:
    ...
    if world_size != 8:
        raise ValueError(
            f"Rascal 4k 12L brotli+mixed 8x requires WORLD_SIZE=8, got {world_size}. "
            "Launch with: torchrun --standalone --nproc_per_node=8 4k_vocab_rascal_12l_brotli_mixed/train_gpt_4K_12L_brotli_mixed_8xgpu.py"
        )
    ...
    log0("condition_id:rascal_4k_12L_brotli_mixed_8x_seed444")
    log0("run_label:salvage_v2 source_record:rascal_4k_8x_seed444_run20260427 axis:depth_12L+brotli+mixed_int")
