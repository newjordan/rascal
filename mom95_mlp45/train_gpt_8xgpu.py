...
os.environ.setdefault("RUN_ID", "rascal_mom95_mlp45_8x_seed444_" + time.strftime("%Y%m%d_%H%M%S"))
...
def main() -> None:
    ...
    if world_size != 8:
        raise ValueError(
            f"Rascal mom95+mlp45 8x requires WORLD_SIZE=8, got {world_size}. "
            "Launch with: torchrun --standalone --nproc_per_node=8 mom95_mlp45/train_gpt_8xgpu.py"
        )
    ...
    log0("condition_id:rascal_mom95_mlp45_8x_seed444")
    log0("run_label:promotion source_record:Rascal_II_8xH100_seed444 axis:muon_momentum_0.95+mlp_mult_4.5")
