...
TEST_ID = "2026-04-30_pr1855_sp10240_caseops_repro_embed6_8x"
...
HYPOTHESIS = (
    "Size-cut response to the strong SP10240 CaseOps repro: keep the PR1855 "
    "body, loops, LQER, pergroup compression, and phased TTT fixed while cutting "
    "tok_emb from int7 to int6 to recover the 450KB byte overflow."
)
...
Hyperparameters.run_id = "pr1855_sp10240_caseops_repro_embed6_8x_seed42"
