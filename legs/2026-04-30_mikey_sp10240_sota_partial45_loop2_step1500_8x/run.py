...
TEST_ID='2026-04-30_mikey_sp10240_sota_partial45_loop2_step1500_8x'
...
PARENT_RUN='2026-04-29_mikey_sp10240_full124_loop2_late050_mlp375_clip1305_8x'
HYPOTHESIS='SOTA parent partial-loop repair: keep the proven SP10240 11L MLP3.75 body and quant/eval policy fixed, but reduce loop shock by repeating only L4-5 with loop2 and turn that partial loop on at step 1500.'
...
Hyperparameters.run_id='mikey_sp10240_sota_partial45_loop2_step1500_8x_seed444'
...
Hyperparameters.loop_start=4
Hyperparameters.loop_end=5
Hyperparameters.enable_looping_at=.50
Hyperparameters.loop_enable_step=1500
...
def train_model(h,device,val_data):
	...
	while True:
		...
		if h.num_loops>0 and not base_model.looping_active and (step>=getattr(h,'loop_enable_step',10**12) or frac>=h.enable_looping_at):base_model.looping_active=True;log(f"layer_loop:enabled step:{step} frac:{frac:.3f} encoder:{base_model.encoder_indices} decoder:{base_model.decoder_indices}")
