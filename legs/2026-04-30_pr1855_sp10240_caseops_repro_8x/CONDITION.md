# PR1855 SP10240 CaseOps Repro Port

Run label: `new_experiment`, `standard_8x`.

This is the first true 10k CaseOps runner. It keeps the accepted PR1855
CaseOps/LQER/pergroup/phased-TTT stack shape and changes the vocab/data lane
from SP8192 CaseOps to the new SP10240 CaseOps tokenizer and byte-sidecar data.
...
```bash
cd /workspace/sota_rascal/legs/2026-04-30_pr1855_sp10240_caseops_repro_8x
./launch_8x.sh
tail -f logs/pr1855_sp10240_caseops_repro_8x_seed42.txt
```
