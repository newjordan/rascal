...
os.environ.setdefault("RUN_ID", "raphe_1p1_sp4096_2x_seed444_" + time.strftime("%Y%m%d_%H%M%S"))

TEST_ID = "2026-04-28_raphe_1p1_sp4096_2x"
...
def main() -> None:
    ...
    log0("changed_fields:gpus 8->2, world_size 8->2, grad_accum_steps 1->4, wallclock 600->2400")
