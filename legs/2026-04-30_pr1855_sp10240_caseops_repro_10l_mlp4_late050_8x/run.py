...
# ===== 2026-04-30 SP10240 CaseOps PR1855-port 10L MLP4 late050 test car =====
...
TEST_ID = "2026-04-30_pr1855_sp10240_caseops_repro_10l_mlp4_late050_8x"
...
HYPOTHESIS = (
    "Take the strongest SP10240 CaseOps MLP4 PR1855-port body down one layer "
    "to recover the 16MB byte cap without cutting MLP width. Keep CaseOps, "
    "LQER top3, pergroup compression, and phased TTT fixed, but move loop "
    "activation to late050 because 6x mechanics showed MLP4 late050 as the "
    "best neural signal."
)
...
Hyperparameters.run_id = "pr1855_sp10240_caseops_repro_10l_mlp4_late050_8x_seed42"
...
Hyperparameters.parallel_start_layer = 7
