...
TEST_ID='2026-04-29_mikey_II_v5_sp5200_loop2_12l_1x'
...
PARENT_RUN='/workspace/Mikey_II_v5, run_id=v5_wd03'
HYPOTHESIS='Clean Mikey II v5 SP5200 loop2 with vocab savings spent on 12L balanced recurrence, explicit WD=0.5, and EMA disabled.'
...
Hyperparameters.run_id='mikey_II_v5_sp5200_loop2_12l_1x_seed1337'
Hyperparameters.max_wallclock_seconds=float(BUILD_SECONDS)
Hyperparameters.vocab_size=5200
Hyperparameters.num_layers=12
Hyperparameters.xsa_last_n=12
Hyperparameters.mlp_mult=3.
Hyperparameters.warmdown_frac=.3
Hyperparameters.train_log_every=50
Hyperparameters.val_loss_every=0
Hyperparameters.sliding_window_enabled=False
Hyperparameters.num_loops=2
Hyperparameters.adam_wd=.5
Hyperparameters.muon_wd=.5
Hyperparameters.embed_wd=.5
