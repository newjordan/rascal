...
TEST_ID='2026-04-29_whale_h3_delayed_loop_activation_l12_dim576_matrixbits5_sp10240_8x'
TEST_DATE='2026-04-29'
RUN_LABEL='standard_8x'
EXPERIMENT_CLASS='new_experiment_size_risk'
SOURCE_BODY='/home/frosty40/sota_rascal/whale_donor/train_gpt.py'
SOURCE_BODY_SHA256='958bd4e44b6545b426418a92407498b0997ea25a1e1e6af7dfaf6f3ebcbc98aa'
SOURCE_CONDITION_ARTIFACT='/home/frosty40/SOTA_FINAL/legs/2026-04-15_whale_l12_dim576_matrixbits5/tracked_env.sh'
SOURCE_CONDITION_SHA256='037aae6e0bab8ed9a70381d056010d40f0adf1876805893511d8d12fa7182281'
SOURCE_TEST_CAR='/home/frosty40/sota_rascal/legs/2026-04-29_whale_l12_dim576_matrixbits5_sp10240_8x/run.py'
SOURCE_TEST_CAR_SHA256='7236314b20d2cdfa0c8ea8cff4ff757989e1e556f359318abef851606584bff7'
SOURCE_LAUNCHER='/home/frosty40/sota_rascal/legs/2026-04-29_whale_l12_dim576_matrixbits5_sp10240_8x/launch_8x.sh'
SOURCE_LAUNCHER_SHA256='89f08aff9f953f6dc62040ff80209b2f41ac87dc29ac9cd2677e4b15c2a0f56d'
PARENT_RUN='2026-04-29_whale_l12_dim576_matrixbits5_sp10240_8x'
HYPOTHESIS='H3 delayed-loop activation test: preserve 12L dim576 SP10240 whale and matrixbits5 global int5 policy, delay loop activation from 0.35 to 0.55, and disable the reset-only loop warmup stage.'
...
Hyperparameters.experiment_class=EXPERIMENT_CLASS
...
Hyperparameters.source_test_car=SOURCE_TEST_CAR
Hyperparameters.source_test_car_sha256=SOURCE_TEST_CAR_SHA256
Hyperparameters.source_launcher=SOURCE_LAUNCHER
Hyperparameters.source_launcher_sha256=SOURCE_LAUNCHER_SHA256
...
Hyperparameters.run_id='whale_h3_delayed_loop_activation_l12_dim576_matrixbits5_sp10240_8x_seed444'
...
Hyperparameters.tokenizer_path=os.path.join(Hyperparameters.data_dir,'tokenizers','fineweb_10240_bpe.model')
...
def train_model(h,device,val_data):
	...
	if h.warmup_steps>0:
		...
		loop_warmup_steps=int(getattr(h,'loop_warmup_steps',h.warmup_steps))
		if h.num_loops>0 and loop_warmup_steps>0:
			base_model.looping_active=True;log(f"loop_warmup:enabled steps:{loop_warmup_steps} encoder:{base_model.encoder_indices} decoder:{base_model.decoder_indices}")
			for warmup_step in range(loop_warmup_steps):
				step_fn(warmup_step,1.)
				if warmup_step<=5 or(warmup_step+1)%10==0 or warmup_step+1==loop_warmup_steps:log(f"loop_warmup_step: {warmup_step+1}/{loop_warmup_steps}")
			base_model.looping_active=False
		elif h.num_loops>0:log('loop_warmup:disabled')
