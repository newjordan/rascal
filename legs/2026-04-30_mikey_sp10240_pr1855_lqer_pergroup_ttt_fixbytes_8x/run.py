...
# ===== 2026-04-30 10k PR1855-port test car =====
# Source of truth for this new experiment. The launcher should not override
# these condition fields except for CUDA device selection.
TEST_ID = "2026-04-30_mikey_sp10240_pr1855_lqer_pergroup_ttt_fixbytes_8x"
TEST_DATE = "2026-04-30"
RUN_LABEL = "standard_8x"
RUN_KIND = "new_experiment"
SOURCE_PARENT = "legs/2026-04-29_mikey_sp10240_full124_loop2_late050_mlp375_clip1305_8x/run.py"
SOURCE_PARENT_SHA256 = "b7a22bf7287ccefbad0ab879a201bd207060b97eec53a080e6ffd32da5248648"
SOURCE_DONOR = "legs/2026-04-30_pr1855_sp8192_lqer_smeargate_repro_8x/run.py"
SOURCE_DONOR_SHA256 = "454f710d174be80f4603069ca952833d694f60d1d34c0c25703528323bc8878b"
PARENT_RUN = "2026-04-29_mikey_sp10240_full124_loop2_late050_mlp375_clip1305_8x"
HYPOTHESIS = (
    "Port PR1855 compression/eval machinery onto the known-best standard SP10240 "
    "Mikey body: standard 10k data, loop2 late050, MLP3.75, LQER asym, pergroup "
    "compression, sparse/smear gates, PR1855 clip policy, and phased LoRA TTT. "
    "CaseOps byte sidecar is intentionally off; diagnostic eval uses the standard "
    "SentencePiece byte-count LUT fallback when no sidecar is present."
)
...
Hyperparameters.source_donor = SOURCE_DONOR
Hyperparameters.source_donor_sha256 = SOURCE_DONOR_SHA256
...
# Parent 10k data/body/loop condition.
Hyperparameters.data_dir = "/workspace/SOTA_FINAL/data"
Hyperparameters.vocab_size = 10240
Hyperparameters.datasets_dir = "/workspace/SOTA_FINAL/data/datasets/fineweb10B_sp10240"
...
Hyperparameters.tokenizer_path = "/workspace/SOTA_FINAL/data/tokenizers/fineweb_10240_bpe.model"
Hyperparameters.caseops_enabled = False
Hyperparameters.seed = 444
Hyperparameters.run_id = "mikey_sp10240_pr1855_lqer_pergroup_ttt_fixbytes_8x_seed444"
...
Hyperparameters.enable_looping_at = 0.50
Hyperparameters.qk_gain_init = 5.25
Hyperparameters.warmup_steps = 20
Hyperparameters.warmdown_frac = 0.72
Hyperparameters.train_batch_tokens = 786432
Hyperparameters.train_seq_len = 2048
Hyperparameters.val_batch_tokens = 524288
Hyperparameters.eval_seq_len = 2048
...
Hyperparameters.muon_momentum = 0.97
Hyperparameters.muon_backend_steps = 5
Hyperparameters.muon_wd = 0.095
Hyperparameters.embed_wd = 0.085
Hyperparameters.adam_wd = 0.02
Hyperparameters.beta2 = 0.99
Hyperparameters.grad_clip_norm = 0.3
Hyperparameters.ema_decay = 0.9965

# PR1855-port quant/compression/eval machinery that does not require CaseOps.
...
Hyperparameters.matrix_clip_sigmas = 12.85
...
# PR1855 phased LoRA TTT path, on standard token BPB accounting.
Hyperparameters.ttt_enabled = True
Hyperparameters.phased_ttt_prefix_docs = 2500
Hyperparameters.phased_ttt_num_phases = 3
Hyperparameters.global_ttt_lr = 0.001
Hyperparameters.global_ttt_momentum = 0.9
Hyperparameters.global_ttt_epochs = 1
Hyperparameters.global_ttt_chunk_tokens = 32768
Hyperparameters.global_ttt_batch_seqs = 32
Hyperparameters.global_ttt_warmup_start_lr = 0.0
Hyperparameters.global_ttt_warmup_chunks = 0
Hyperparameters.global_ttt_grad_clip = 1.0
Hyperparameters.global_ttt_respect_doc_boundaries = True
Hyperparameters.ttt_lora_rank = 80
Hyperparameters.ttt_lora_lr = 0.0001
Hyperparameters.ttt_chunk_size = 48
Hyperparameters.ttt_eval_seq_len = 2048
Hyperparameters.ttt_batch_size = 64
Hyperparameters.ttt_grad_steps = 1
Hyperparameters.ttt_weight_decay = 0.5
Hyperparameters.ttt_beta1 = 0.0
Hyperparameters.ttt_beta2 = 0.99
Hyperparameters.ttt_k_lora = True
Hyperparameters.ttt_mlp_lora = True
Hyperparameters.ttt_o_lora = True
Hyperparameters.ttt_optimizer = "adam"
Hyperparameters.ttt_eval_batches = ""
    ...
    with torch.no_grad():
        for batch_seq_start in range(seq_start, seq_end, local_batch_seqs):
            ...
            if val_data.caseops_enabled and val_data.val_bytes is not None:
                ...
                tok_bytes = sidecar_slice.to(torch.float64)
            else:
                tok_bytes = val_data.base_bytes_lut[tgt_ids].to(torch.float64)
                tok_bytes += (
