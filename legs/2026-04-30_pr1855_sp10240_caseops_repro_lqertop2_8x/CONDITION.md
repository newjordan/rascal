# PR1855 SP10240 CaseOps Repro LQER Top-2

Run label: `new_experiment`, `standard_8x`.

This is a byte-budget response to the strong but over-cap SP10240 CaseOps MLP4
repro. It keeps the PR1855 body, loop timing, embed int7, pergroup compression,
and phased TTT fixed, and changes only LQER correction from top-3 tensors to
top-2 tensors.
...
- Quant/compression: pergroup, embed int7, matrix int6, LQER asym rank 4, top-k `2`
- Eval: PR1855 phased LoRA TTT, prefix docs `2500`, phases `3`

## Command

```bash
cd /workspace/sota_rascal/legs/2026-04-30_pr1855_sp10240_caseops_repro_lqertop2_8x
./launch_8x.sh
tail -f logs/pr1855_sp10240_caseops_repro_lqertop2_8x_seed42.txt
```
