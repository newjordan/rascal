...
TEST_ID = "2026-04-30_pr1855_sp10240_caseops_repro_lqertop2_8x"
...
HYPOTHESIS = (
    "Keep the strong SP10240 CaseOps MLP4 neural body intact and try to recover "
    "the 450KB byte overrun by reducing LQER correction from top-3 tensors to "
    "top-2 tensors. This tests quant-repair byte savings before cutting MLP."
)
...
Hyperparameters.run_id = "pr1855_sp10240_caseops_repro_lqertop2_8x_seed42"
