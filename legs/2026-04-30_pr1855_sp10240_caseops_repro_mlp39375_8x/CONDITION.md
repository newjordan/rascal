# PR1855 SP10240 CaseOps Repro MLP3.9375 Size Cut
...
TTT fixed, and changes only `mlp_mult: 4.0 -> 3.9375`.
...
- PR1855 body: `num_layers=11`, `model_dim=512`, `mlp_mult=3.9375`, hidden dim `2016`
...
```bash
cd /workspace/sota_rascal/legs/2026-04-30_pr1855_sp10240_caseops_repro_mlp39375_8x
./launch_8x.sh
tail -f logs/pr1855_sp10240_caseops_repro_mlp39375_8x_seed42.txt
```
