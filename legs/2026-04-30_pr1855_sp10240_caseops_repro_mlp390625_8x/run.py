...
# ===== 2026-04-30 SP10240 CaseOps PR1855-port test car =====
...
TEST_ID = "2026-04-30_pr1855_sp10240_caseops_repro_mlp390625_8x"
...
HYPOTHESIS = (
    "Size-cut response to the strong SP10240 CaseOps repro: keep PR1855 "
    "CaseOps/LQER/pergroup/phased-TTT and embed int7 fixed while trimming MLP "
    "from 4.0 to 3.90625. Hidden dim becomes 2000, preserving alignment while "
    "trying to stay under the byte cap with more capacity than MLP3.875."
)
...
Hyperparameters.run_id = "pr1855_sp10240_caseops_repro_mlp390625_8x_seed42"
...
Hyperparameters.mlp_mult = 3.90625
