...
TEST_ID='2026-04-29_mikey_sp5200_mlp425_ema0_wd05_noloop_gptq_8x'
...
HYPOTHESIS='SP5200 MLP4.25 cap-safe GPTQ swing using the 1x kernel/schedule findings: EMA off, warmdown 0.5, no loops, reduce-overhead compile on 8x, rotary precompute, sliding eval, and legal score-first TTT.'
...
Hyperparameters.run_id='mikey_sp5200_mlp425_ema0_wd05_noloop_gptq_8x_seed1337'
...
Hyperparameters.compile_mode='reduce-overhead'
