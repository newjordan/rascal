# PR1855 SP10240 CaseOps Repro 10L MLP4.25 Late050

Run label: `new_experiment`, `standard_8x`.

This takes the closest over-cap SP10240 CaseOps MLP4 PR1855-port body down one
layer. The 10L MLP4 drop fit at about `15.20MB`, leaving roughly `0.80MB`
unused. This variant spends that spare byte budget on MLP width: `4.0 -> 4.25`,
while keeping late050 loop timing from the 6x mechanics signal.
...
- PR1855 body adjusted: `num_layers=10`, `model_dim=512`, `mlp_mult=4.25`, `parallel_start_layer=7`
