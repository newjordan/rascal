...
# ===== 2026-04-30 SP10240 CaseOps PR1855-port 10L MLP4.25 late050 test car =====
...
TEST_ID = "2026-04-30_pr1855_sp10240_caseops_repro_10l_mlp425_late050_8x"
...
HYPOTHESIS = (
    "Spend the spare byte budget from the 10L MLP4 layer-drop on MLP width. "
    "Keep the 10L byte-saving body and late050 loop timing, but raise MLP from "
    "4.0 to 4.25 to recover neural quality without taking the illegal/large "
    "dimension jump."
)
...
Hyperparameters.run_id = "pr1855_sp10240_caseops_repro_10l_mlp425_late050_8x_seed42"
