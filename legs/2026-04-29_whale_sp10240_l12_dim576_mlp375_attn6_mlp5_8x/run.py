...
TEST_ID='2026-04-29_whale_sp10240_l12_dim576_mlp375_attn6_mlp5_8x'
TEST_DATE='2026-04-29'
RUN_LABEL='standard_8x'
EXPERIMENT_CLASS='new_experiment_quant_repair'
...
PARENT_RUN='2026-04-15_whale_l12_dim576_matrixbits5'
HYPOTHESIS='Whale SP10240 quant repair: preserve 12L dim576 loop2 donor geometry, shave MLP to 3.75 to buy bytes, and spend them on int6 attention matrices while keeping MLP matrices int5 and embeddings int8.'
...
Hyperparameters.run_id='whale_sp10240_l12_dim576_mlp375_attn6_mlp5_8x_seed444'
...
Hyperparameters.mlp_matrix_bits=5
...
def gptq_mixed_quantize(state_dict,hessians,h):
	...
	for(name,tensor)in state_dict.items():
		...
		elif'.attn.'in name:bits=h.attn_matrix_bits
		elif'.mlp.'in name:bits=h.mlp_matrix_bits
