...
TEST_ID='2026-04-29_mikey_sp8192_predictive_loop_aux_mse_8x'
TEST_DATE='2026-04-29'
RUN_LABEL='standard_8x'
SOURCE_BODY='legs/mikey_ii_baseline/runs/06_predictive_loop_aux_mse/train_gpt.py'
SOURCE_CONDITION_ARTIFACT='user table row 06: Predictive loop final-pass forecast + aux MSE, RoPE pos_shift on Q only, weights shared'
PARENT_RUN='legs/2026-04-29_mikey_pr1493parity_sp8192_loop2_mlp4_8x/run.py'
HYPOTHESIS='SP8192 Mikey loop2 with predictive-loop final-pass forecast auxiliary MSE, repaired to MLP_MULT=4.0 and QK_GAIN_INIT=5.25 parity.'
...
Hyperparameters.run_id='mikey_sp8192_predictive_loop_aux_mse_mlp4_qk525_8x_seed1337'
