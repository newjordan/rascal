...
TEST_ID='2026-04-29_claude_ppm_byte_sp8192_8x'
TEST_DATE='2026-04-29'
RUN_LABEL='standard_8x_claude_candidate'
SOURCE_BODY='legs/mikey_ii_baseline/runs/01_ppm_byte_mixture/train_gpt.py'
SOURCE_CONDITION_ARTIFACT='legs/mikey_ii_baseline/port_plans/01_ppm_byte_mixture.md'
PARENT_RUN='legs/mikey_ii_baseline/train_gpt.py'
HYPOTHESIS='Claude candidate 01: native byte-level PPM mixture on SP8192 post-quant sliding/TTT stream; high-upside eval-time byte surprisal recovery without changing training.'
...
Hyperparameters.run_id='claude_ppm_byte_sp8192_8x_seed1337'
