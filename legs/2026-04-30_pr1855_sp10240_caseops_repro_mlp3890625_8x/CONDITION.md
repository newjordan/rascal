# PR1855 SP10240 CaseOps Repro MLP3.890625 Size Cut

Run label: `new_experiment`, `standard_8x`.

This is the fourth size-cut response to the strong SP10240 CaseOps repro. It
keeps embed int7, LQER rank/top-k, pergroup compression, loop timing, and phased
TTT fixed, and changes only `mlp_mult: 4.0 -> 3.890625`.
...
- PR1855 body: `num_layers=11`, `model_dim=512`, `mlp_mult=3.890625`, hidden dim `1992`
...
```bash
cd /workspace/sota_rascal/legs/2026-04-30_pr1855_sp10240_caseops_repro_mlp3890625_8x
./launch_8x.sh
tail -f logs/pr1855_sp10240_caseops_repro_mlp3890625_8x_seed42.txt
```
