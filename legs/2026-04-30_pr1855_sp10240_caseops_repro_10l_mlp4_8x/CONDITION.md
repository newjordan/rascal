# PR1855 SP10240 CaseOps Repro 10L MLP4
...
```bash
cd /workspace/sota_rascal/legs/2026-04-30_pr1855_sp10240_caseops_repro_10l_mlp4_8x
./launch_8x.sh
tail -f logs/pr1855_sp10240_caseops_repro_10l_mlp4_8x_seed42.txt
```
