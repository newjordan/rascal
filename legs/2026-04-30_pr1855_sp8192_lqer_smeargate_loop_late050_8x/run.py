...
# ===== 2026-04-30 PR1855 CaseOps loop-timing variant =====
# Source of truth for this new experiment. The launcher sets only data paths,
# dependency gates, and this same explicit condition for clarity.
TEST_ID = "2026-04-30_pr1855_sp8192_lqer_smeargate_loop_late050_8x"
...
PARENT_RUN = "2026-04-30_pr1855_sp8192_lqer_smeargate_repro_8x_seed42"
HYPOTHESIS = (
    "PR1855 exact CaseOps/LQER/SparseGate/SmearGate body with only loop "
    "activation delayed from the PR1855 0.35 gate to 0.50. This tests whether "
    "the loop work that helped Mikey stabilizes the accepted 8k CaseOps stack "
    "without changing tokenizer, data, quant, compression, or phased TTT."
)
...
Hyperparameters.run_id = "pr1855_sp8192_lqer_smeargate_loop_late050_8x_seed42"
Hyperparameters.logfile = "logs/pr1855_sp8192_lqer_smeargate_loop_late050_8x_seed42.txt"
