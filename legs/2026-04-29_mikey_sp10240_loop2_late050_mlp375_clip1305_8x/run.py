...
TEST_ID='2026-04-29_mikey_sp10240_first80_loop2_late050_mlp375_clip1305_8x'
...
PARENT_RUN='2026-04-29_mikey_sp8192_loop2_late050_8x plus Hugging Face Frosty40/10k_golfer sha 167d9f87d2294d8d93e04d17ca611d8bdbfb4518 first80 condition'
HYPOTHESIS='SP10240 tokenizer swing: use the 10k_golfer tokenizer/data first 80 train shards, keep proven Mikey loop2 L3-5 late050 topology, reduce MLP to 3.75 for expected byte fit, and use matrix GPTQ clip 13.05.'
...
Hyperparameters.run_id='mikey_sp10240_first80_loop2_late050_mlp375_clip1305_8x_seed444'
...
Hyperparameters.datasets_dir=os.path.join(Hyperparameters.data_dir,'datasets','fineweb10B_sp10240_first80')
