# Mikey SP10240 PR1855 LQER/Pergroup/TTT Port
...
```bash
cd /workspace/sota_rascal/legs/2026-04-30_mikey_sp10240_pr1855_lqer_pergroup_ttt_8x
./launch_8x.sh
tail -f logs/mikey_sp10240_pr1855_lqer_pergroup_ttt_8x_seed444.txt
```
