...
TEST_ID='2026-04-29_mikey_sp5200_mlp425_loop2_late045_1x'
...
HYPOTHESIS='1x mechanics proxy for SP5200 MLP4.25 loop2 with softer loop timing: keep MLP4.25 and loop2 topology, delay loop activation 0.35->0.45 to test whether late recurrence avoids the loop3 regression while preserving the 5k byte budget.'
...
Hyperparameters.run_id='mikey_sp5200_mlp425_loop2_late045_1x_seed1337'
