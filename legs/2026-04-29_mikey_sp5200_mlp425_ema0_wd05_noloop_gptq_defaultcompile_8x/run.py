...
TEST_ID='2026-04-29_mikey_sp5200_mlp425_ema0_wd05_noloop_gptq_defaultcompile_8x'
...
HYPOTHESIS='SP5200 MLP4.25 cap-safe GPTQ swing using the 1x schedule findings: EMA off, warmdown 0.5, no loops, default compile after reduce-overhead cudagraph crash, rotary precompute, sliding eval, and legal score-first TTT.'
...
Hyperparameters.run_id='mikey_sp5200_mlp425_ema0_wd05_noloop_gptq_defaultcompile_8x_seed1337'
