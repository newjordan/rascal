...
TEST_ID='2026-04-30_mikey_sp10240_9l_dim576_mlp375_loop_late060_nowarm_emb7_mlpclip12_8x'
...
PARENT_RUN='2026-04-30_mikey_sp10240_9l_dim576_mlp375_loop_late060_nowarm_8x'
HYPOTHESIS='Switch-body high-risk 9-layer cake with quant-policy repair: use FA3-valid dim576/head_dim72 with MLP3.75, delayed/no-warm loops, embed int7, and MLP-specific GPTQ clip 12.0.'
...
Hyperparameters.run_id='mikey_sp10240_9l_dim576_mlp375_loop_late060_nowarm_emb7_mlpclip12_8x_seed444'
...
Hyperparameters.embedding_dim=576
...
Hyperparameters.enable_looping_at=.60
Hyperparameters.loop_warmup_enabled=False
...
def train_model(h,device,val_data):
	...
	if h.warmup_steps>0:
		...
		if h.num_loops>0 and getattr(h,'loop_warmup_enabled',True):
			...
			log("loop_warmup:disabled explicitly")
