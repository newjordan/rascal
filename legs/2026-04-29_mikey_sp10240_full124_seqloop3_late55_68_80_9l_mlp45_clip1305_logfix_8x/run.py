...
TEST_ID='2026-04-29_mikey_sp10240_full124_seqloop3_late55_68_80_9l_mlp45_clip1305_logfix_8x'
...
PARENT_RUN='2026-04-29_mikey_sp10240_full124_loop2_late050_9l_mlp45_clip1305_8x'
HYPOTHESIS='SP10240 full124 9L MLP4.5 sequential loop3 swing with compile/log repair: test whether a wider fast 9L body can absorb staged extra loop pressure at frac 0.55/0.68/0.80 while disabling fullgraph compile and enabling dynamic compile so rank-local batch-size variation does not spam recompile-limit warnings.'
...
Hyperparameters.run_id='mikey_sp10240_full124_seqloop3_late55_68_80_9l_mlp45_clip1305_logfix_8x_seed444'
Hyperparameters.max_wallclock_seconds=float(BUILD_SECONDS)
Hyperparameters.vocab_size=10240
Hyperparameters.num_layers=9
Hyperparameters.xsa_last_n=9
Hyperparameters.mlp_mult=4.5
...
Hyperparameters.enable_looping_at=.55
Hyperparameters.loop_schedule_enabled=True
Hyperparameters.loop_schedule_fracs=(.55,.68,.80)
